...
export declare class FormBuilder {
    ...
    showConformation(receiver: Player, body: string, callbackIfYes: (receiver: Player) => {}, callbackIfNo: (receiver: Player) => {}): Promise<FormCancelationReason | undefined>;
    /**
     ...
     */
    showConformationAwait(receiver: Player, body: string, callbackIfYes: (receiver: Player) => {}, callbackIfNo: (receiver: Player) => {}): Promise<void>;
    /**
     * @method showAwait
     * @param {Player} receiver
     * @param {String} key
