...
import { andArray, betweenBlockVector3, blockFaceToCoords, content, isDefined, isVector3, orArray, overworld, server, isVector2Or3, isVector2 } from "./../utilities.js";
    ...
    setCurrent(player, key) {
        ...
        if (teleport) {
            ...
            if (teleportKey)
                ...
                teleportLocation = (teleportLocation instanceof PlotsVector3) ? { location: start, offset: teleportLocation } : { location: teleportLocation, offset: { x: 0, y: 0, z: 0 } };
                if (!isVector2(face))
                    face = (face instanceof PlotsVector3) ? { location: start, offset: face } : { location: face, offset: { x: 0, y: 0, z: 0 } };
